...
$(document).ready(function(){
   ...
   $(':file').change(function () {    
    ...
    }else var uitvoer = '<div class="bericht">'  + '<li class="item"><span>' + '<img src="../imgs/profiel1.png">' +  invoer + afbeelding + '</span><img class="edit" src="imgs/edit.png" height="16" width="16"><img class="delete" src="imgs/delete.png" height="16" width="16">  <div class="waardering"><div class="likes">1</div><div class=""><img href="#" class="addLike" src="imgs/like.png" height="16" width="16"></div></div></div> </li>' +  '</div>' ;
 ...
 $("#reageerKnop").on("click", function(){
  ...
  var reageren = function(){
        ...
        var uitvoer = '<div class="reactie2">'+ '<li class="item"><span>'+'<img src="../imgs/profiel1.png">' + invoer+ '</span><img class="edit" src="imgs/edit.png" height="16" width="16"><img class="delete" src="imgs/delete.png" height="16" width="16"><div class="waardering"><div class="likes">1</div><div class=""><img href="#" class="addLike" src="imgs/like.png" height="16" width="16"></div></div></div> </li>' +  '</div>' ;
